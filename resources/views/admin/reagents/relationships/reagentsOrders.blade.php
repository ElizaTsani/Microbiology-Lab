...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-reagentsOrders">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($orders as $key => $order)
                        <tr data-entry-id="{{ $order->id }}">
                            ...
                            <td>
                                @foreach($order->reagents as $key => $item)
...
@endcan
  ...
  let table = $('.datatable-reagentsOrders:not(.ajaxTable)').DataTable({ buttons: dtButtons })
