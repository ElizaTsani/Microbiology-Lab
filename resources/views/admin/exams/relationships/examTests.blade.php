...
<div class="card">
    ...
    <div class="card-body">
        <div class="table-responsive">
            <table class=" table table-bordered table-striped table-hover datatable datatable-examTests">
                <thead>
                    <tr>
                        <th width="10">
                ...
                <tbody>
                    @foreach($tests as $key => $test)
                        <tr data-entry-id="{{ $test->id }}">
                            ...
                            <td>
                                <span style="display:none">{{ $test->customer_received ?? '' }}</span>
...
@endcan
  ...
  let table = $('.datatable-examTests:not(.ajaxTable)').DataTable({ buttons: dtButtons })
